...
namespace ElevatorSystem
{
    class Program
    {
        ...
        {
            ServiceProvider services = new ServiceCollection().AddSingleton<IElevatorService, ElevatorService>().BuildServiceProvider(); ;
            IElevatorService elevatorService = services.GetService<IElevatorService>();


            elevatorService.RunElevatorSystem();



            /* Floor floorID = new Floor {  FloorId = 0};
            Elevator elevator = new Elevator { CurrentFloor = 1, IsAvailable = true , NumberOfPeopleInElevator = 0};
